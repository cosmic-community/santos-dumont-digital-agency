      ...
      <div className="container-custom py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            <h3 className="text-2xl font-bold mb-4">Santos Dumont</h3>
            <p className="text-secondary-300 mb-4">
              "As invenções são sobretudo o resultado de um trabalho teimoso"
            </p>
            <p className="text-secondary-400 text-sm">
              © {new Date().getFullYear()} Santos Dumont Digital Agency. All rights reserved.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/#team" className="text-secondary-300 hover:text-white transition-colors">
                  Team
                </Link>
              </li>
              <li>
